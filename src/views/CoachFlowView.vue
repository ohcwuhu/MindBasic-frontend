  ...
  <div class="max-w-[1080px] mx-auto px-4 md:px-6 py-10 md:py-16">
    ...
    <template v-else-if="template">
      <div class="mt-6 flex items-center justify-between">
        <p class="catalog-tab">{{ template.name }}</p>
      ...
      <section ref="cardEl" v-else class="relative card mt-6 p-6 md:p-10 text-center">
        <WarmMotif name="sprout" class="absolute right-6 top-6 w-16 h-16 text-sage opacity-25 hidden md:block" />
