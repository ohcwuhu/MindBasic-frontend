...
const coverGradients = [
  'linear-gradient(135deg, #9c5a40 0%, #efddd0 100%)',
  'linear-gradient(135deg, #d9a14c 0%, #f6e4c4 100%)',
  'linear-gradient(135deg, #b58d8a 0%, #ecd2cc 100%)',
  'linear-gradient(135deg, #a98f6e 0%, #e7d8bf 100%)',
  'linear-gradient(135deg, #c08a78 0%, #f0dccd 100%)',
]
